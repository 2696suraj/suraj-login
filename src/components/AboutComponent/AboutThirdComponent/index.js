...
const AboutThirdComponent = () => {
  ...
  return (
    <div className="AboutThirdComponent-ClientTestimonlals-bg-co">
      <div className="ClientTestimonlals-card-co">
        <div data-aos="flip-right" className="clienttest-top-heding-bg-co">
        ...
        <div   data-aos="flip-right" className="clienttest-card-bg-co">
